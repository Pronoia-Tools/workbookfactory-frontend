<template>
  <c-box>
    <c-box v-if="isLoading" class="loading">
      <loading-screen />
    </c-box>
                ...
                <c-box as="tbody" py="4" font-size="sm">
                  ...
                  >
                    ...
                    <c-box as="td">
                      ...
                      <span
                        v-else-if="!workbook.published && workbook.editable"
                      >
                        Uneditable
                      </span>
                    ...
                    <c-flex class="items-center" as="td">
                      ...
                      <c-box class="mx-1">
                        <nuxt-link
                          :to="`/author/workbooks/${workbook.id}/edit`"
                        >
                          <c-icon-button
                            variant="outline"
                            variant-color="vue"
                      ...
                      <c-box class="mx-1">
                        <nuxt-link
                          :to="`/author/workbooks/${workbook.id}/editor`"
                        >
                          <c-icon-button
                            variant="outline"
                            variant-color="vue"
